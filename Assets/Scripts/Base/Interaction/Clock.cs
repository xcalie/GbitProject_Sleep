...
public class Clock : InteracitonBase
{
    //进入交互范围的东西
    ...
    protected override void Interact()
    {
        ...
        AbilityPickup.Instance.GetAbility(AbilityType.TimeStop, other);
        AbilityPickup.Instance.GetAbility(AbilityType.TimeSlowDown, other);
